<aside class="share hidden-xs hidden-sm">
  <p>SHARE</p>
  <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php the_permalink($post->ID); ?>" target="_blank" title="Share on LinkedIn" class="social" rel="nofollow">
  ...
  <a href="http://twitter.com/share?text=<?php the_title();?>&url=<?php the_permalink($post->ID);?>" title="Tweet this!" target="_blank" class="social" rel="nofollow">
  ...
  <a href="http://www.facebook.com/sharer.php?u=<?php the_permalink($post->ID);?>" title="Share on Facebook." target="_blank" class="social" rel="nofollow">
    <svg id="icon-facebook" class="social__icon icon-facebook" width="32" height="32" viewBox="0 0 32 32" x="240" y="0">
      <path d="M19 6h5v-6h-5c-3.86 0-7 3.14-7 7v3h-4v6h4v16h6v-16h5l1-6h-6v-3c0-0.542 0.458-1 1-1z"></path>
    </svg>
  </a>
  <a href="mailto:%20?body=<?php the_permalink($post->ID);?>&subject=<?php urlencode( the_title() ); ?>" class="social" rel="nofollow">
