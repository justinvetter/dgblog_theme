<aside class="share hidden-xs hidden-sm">
  ...
  <a href="http://twitter.com/home/?status=<?php the_title(); ?> - <?php $bitly = getBitly(get_permalink($post->ID)); echo $bitly ?>" title="Tweet this!" target="_blank" class="social">
  ...
  <a href="mailto:%20?body=<?php the_permalink($post->ID);?>,&subject=<?php urlencode( get_the_title( $post->ID ) ); ?>" class="social" target="_blank">
