  ...
  <footer>
    <div class="container">
      ...
      <div class="row no-pad">
        <div class="col-sm-12 col-md-6 col-md-offset-3 no-pad">
          <div class="footer__links clearfix">
            ...
            <div class="col-xs-4">
              <ul class="txt--caps pull-right footer__links--blue">
                <li><a href="https://www.digitalglobe.com/content" target="_blank">Content</a></li>
                <li><a href="https://www.digitalglobe.com/access" target="_blank">Access</a></li>
                <li><a href="https://www.digitalglobe.com/expertise" target="_blank">Expertise</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="footer__social">
        <ul>
          <li>
            <a href="https://twitter.com/digitalglobe" target="_blank" class="social">
          ...
          <li>
            <a href="https://www.facebook.com/DigitalGlobeInc" target="_blank" class="social">
          ...
          <li>
            <a href="https://www.instagram.com/digitalglobe/" target="_blank" class="social">
          ...
          <li>
            <a href="https://www.youtube.com/user/digitalglobeinc" target="_blank" class="social">
          ...
          <li>
            <a href="https://www.linkedin.com/company/digitalglobe" target="_blank" class="social">
          ...
          <li>
            <a href="https://plus.google.com/+digitalglobe/posts" target="_blank" class="social">
          ...
          <li>
            <a href="http://blog.digitalglobe.com/feed" target="_blank" class="social">
              <svg id="icon-feed" class="social__icon icon-feed" width="32" height="32" viewBox="0 0 32 32" x="96" y="0">
